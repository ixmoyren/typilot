...
val DefaultColor: TextAttributesKey = DLHC.STRING

val TypstHighlightTag.Color: TextAttributesKey
    get() = TagPropertyMap[this] ?: DLHC.STRING

private val TagPropertyMap = EnumMap(
    mapOf(
        ...
        TypstHighlightTag.HEADING to key("TypstHeading",),
