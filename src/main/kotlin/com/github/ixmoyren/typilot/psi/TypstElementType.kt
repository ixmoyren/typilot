...
class TypstElementType(val kind: TypstSyntaxKind?, name: String = kind!!.name) : IElementType(name, TypstLanguage.INSTANCE) {
    ...
    companion object {
        ...
        val COMMENT_ELEMENTS: TokenSet = TokenSet.create(TypstSyntaxKind.LINE_COMMENT.elementType, TypstSyntaxKind.BLOCK_COMMENT.elementType, TypstSyntaxKind.SHEBANG.elementType)

        val KEYWORD_ELEMENTS: TokenSet =
            TokenSet.create(
        ...
        val IDENT_ELEMENTS: TokenSet = TokenSet.create(TypstSyntaxKind.IDENT.elementType, TypstSyntaxKind.MATH_IDENT.elementType)

        val LITERAL_ELEMENTS: TokenSet =
            TokenSet.create(
        ...
        val OPERATOR_ELEMENTS: TokenSet =
            TokenSet.create(
