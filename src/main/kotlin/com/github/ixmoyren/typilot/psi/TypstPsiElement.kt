...
val TypstSyntaxKindToPsiElementMap: Map<TypstSyntaxKind, (ASTNode) -> PsiElement> =
    mapOf(
        ...
        TypstSyntaxKind.LineComment() to ::TypstLineCommentPsiElement,
        TypstSyntaxKind.BlockComment() to ::TypstBlockCommentPsiElement,
        ...
        TypstSyntaxKind.SmartQuote() to ::TypstSmartQuotePsiElement,
        ...
        TypstSyntaxKind.RawLang() to ::TypstRawLangPsiElement,
        TypstSyntaxKind.RawDelim() to ::TypstRawDelimPsiElement,
        TypstSyntaxKind.RawTrimmed() to ::TypstRawTrimmedPsiElement,
        ...
        TypstSyntaxKind.RefMarker() to ::TypstRefMarkerPsiElement,
        TypstSyntaxKind.Heading() to ::TypstHeadingPsiElement,
        TypstSyntaxKind.HeadingMarker() to ::TypstHeadingMarkerPsiElement,
        TypstSyntaxKind.ListItem() to ::TypstListItemPsiElement,
        TypstSyntaxKind.ListMarker() to ::TypstListMarkerPsiElement,
        TypstSyntaxKind.EnumItem() to ::TypstEnumItemPsiElement,
        TypstSyntaxKind.EnumMarker() to ::TypstEnumMarkerPsiElement,
        TypstSyntaxKind.TermItem() to ::TypstTermItemPsiElement,
        TypstSyntaxKind.TermMarker() to ::TypstTermMarkerPsiElement,
        TypstSyntaxKind.Equation() to ::TypstEquationPsiElement,
        TypstSyntaxKind.Math() to ::TypstMathPsiElement,
        TypstSyntaxKind.MathText() to ::TypstMathTextPsiElement,
        TypstSyntaxKind.MathIdent() to ::TypstMathIdentPsiElement,
        TypstSyntaxKind.MathShorthand() to ::TypstMathShorthandPsiElement,
        TypstSyntaxKind.MathAlignPoint() to ::TypstMathAlignPointPsiElement,
        TypstSyntaxKind.MathDelimited() to ::TypstMathDelimitedPsiElement,
        TypstSyntaxKind.MathAttach() to ::TypstMathAttachPsiElement,
        ...
        TypstSyntaxKind.LeftBracket() to ::TypstLeftBracketPsiElement,
        TypstSyntaxKind.RightBracket() to ::TypstRightBracketPsiElement,
        TypstSyntaxKind.LeftParen() to ::TypstLeftParenPsiElement,
        TypstSyntaxKind.RightParen() to ::TypstRightParenPsiElement,
        ...
        TypstSyntaxKind.EqEq() to ::TypstEqEqPsiElement,
        TypstSyntaxKind.ExclEq() to ::TypstExclEqPsiElement,
        TypstSyntaxKind.Lt() to ::TypstLtPsiElement,
        TypstSyntaxKind.LtEq() to ::TypstLtEqPsiElement,
        TypstSyntaxKind.Gt() to ::TypstGtPsiElement,
        TypstSyntaxKind.GtEq() to ::TypstGtEqPsiElement,
        TypstSyntaxKind.PlusEq() to ::TypstPlusEqPsiElement,
        TypstSyntaxKind.HyphEq() to ::TypstHyphEqPsiElement,
        TypstSyntaxKind.StarEq() to ::TypstStarEqPsiElement,
        TypstSyntaxKind.SlashEq() to ::TypstSlashEqPsiElement,
        ...
        TypstSyntaxKind.CodeBlock() to ::TypstCodeBlockPsiElement,
        TypstSyntaxKind.ContentBlock() to ::TypstContentBlockPsiElement,
        ...
        TypstSyntaxKind.FieldAccess() to ::TypstFieldAccessPsiElement,
        TypstSyntaxKind.FuncCall() to ::TypstFuncCallPsiElement,
        ...
        TypstSyntaxKind.LetBinding() to ::TypstLetBindingPsiElement,
        TypstSyntaxKind.SetRule() to ::TypstSetRulePsiElement,
        TypstSyntaxKind.ShowRule() to ::TypstShowRulePsiElement,
        TypstSyntaxKind.Contextual() to ::TypstContextualPsiElement,
        TypstSyntaxKind.Conditional() to ::TypstConditionalPsiElement,
        TypstSyntaxKind.WhileLoop() to ::TypstWhileLoopPsiElement,
        TypstSyntaxKind.ForLoop() to ::TypstForLoopPsiElement,
        TypstSyntaxKind.ModuleImport() to ::TypstModuleImportPsiElement,
        TypstSyntaxKind.ImportItems() to ::TypstImportItemsPsiElement,
        TypstSyntaxKind.ImportItemPath() to ::TypstImportItemPathPsiElement,
        TypstSyntaxKind.RenamedImportItem() to ::TypstRenamedImportItemPsiElement,
        TypstSyntaxKind.ModuleInclude() to ::TypstModuleIncludePsiElement,
        TypstSyntaxKind.LoopBreak() to ::TypstLoopBreakPsiElement,
        TypstSyntaxKind.LoopContinue() to ::TypstLoopContinuePsiElement,
        TypstSyntaxKind.FuncReturn() to ::TypstFuncReturnPsiElement,
        TypstSyntaxKind.Destructuring() to ::TypstDestructuringPsiElement,
        TypstSyntaxKind.DestructAssignment() to ::TypstDestructAssignmentPsiElement,
    )
