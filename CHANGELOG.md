...
- **tinymist configuration** — the JSON configuration is sent as LSP `initializationOptions` and is editable in Settings | Tools | Typst with JSON syntax highlighting, schema-based validation and completion.
