...
class TypstTextEditorWithPreviewProvider : TextEditorWithPreviewProvider(TypstPreviewFileEditorProvider()), DumbAware {
    override fun accept(project: Project, file: VirtualFile): Boolean = file.fileType == TypstFileType || file.extension.equals(TypstFileType.defaultExtension, ignoreCase = true)
}
